...
TRANSLATIONS = {
    "en": {
        ...
        "local_sync_export_button": "Export due cards for review",
    ...
    "de": {
        ...
        "local_sync_export_button": "Fällige Karten zur Wiederholung exportieren",
    ...
    "el": {
        ...
        "local_sync_export_button": "Εξαγωγή ληξιπρόθεσμων καρτών για επανάληψη",
